            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Add Program Management</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active"><a href="#">All Program</a></li>
                        <li class="breadcrumb-item active"><a href="#">Add Program</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Courses Involved:</label>
                                            <select id="coursesInvolved" class="form-control" name="coursesInvolved[]"
                                                multiple required>
