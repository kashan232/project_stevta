                    ...
                    <div class="card height-auto">
                        <div class="card-body">
                            ...
                            <form class="new-added-form"
                                action="{{ route('update-employees', ['id' => $employee_details->id]) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        <label>Title/Designation*</label>
                                        <input type="text" name="title_designation" id="title_designation"
                                            placeholder="Enter your Designation" required class="form-control"
                                            value="{{ $employee_details->title_designation }}" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        ...
                                        <select name="department" id="department" placeholder="Enter Your Department"
                                            ...
                                            @foreach ($CampusDepartments as $CampusDepartment)
                                                <option value="{{ $CampusDepartment->dept_name }}">
                                                    {{ $CampusDepartment->dept_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="Text" name="salary" id="salary"
                                            placeholder="Enter Your Salary" required class="form-control"
                                            value="{{ $employee_details->salary }}" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        <label>BPS*</label>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" name="appointment_letter_no" id="appointment_letter_no"
                                            class="form-control"
                                            value="{{ $employee_details->appointment_letter_no }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" name="emergency_contact_name"
                                            id="emergency_contact_name" class="form-control"
                                            value="{{ $employee_details->emergency_contact_name }}" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        <label>Relation*</label>
                                        <input type="text" name="emergency_contact_relation"
                                            id="emergency_contact_relation" class="form-control"
                                            value="{{ $employee_details->emergency_contact_relation }}" />
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        <label>Phone*</label>
                                        <input type="text" name="emergency_contact_phone"
                                            id="emergency_contact_phone" class="form-control"
                                            value="{{ $employee_details->emergency_contact_phone }}" />
                                    </div>
                                </div>
