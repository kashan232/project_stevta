...
<div class="dashboard-page-one">
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="stock">
                        <div class="alert alert-success" id="stock_message" style="display: none;"></div> <!-- Updated this line -->
                        <span>Stock</span>
                        <input type="hidden" name="stock_id" id="stock_id">
                        <input type="number" class="form-control" name="stock" id="stock" placeholder="i.e. 500" required>
                    </div>
                    
                    <div class="modal-footer">
                        <button type="submit" class="fw-btn-fill btn btn-success ">Add Now</button>
                        <button type="button" class="fw-btn-fill btn btn-danger" data-dismiss="modal">cancel</button>
                    </div>
                </div>
                </div>
            </div>
        ...
        <form action="{{ route('store-add-usage') }}" method="POST" id="add_usage">
            @csrf
            <div class="modal fade" id="usageexampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="usageexampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body" id="usage">
                        <div class="alert alert-success" id="usage_message" style="display: none;"></div> <!-- Updated this line -->
                        <span>Usage</span>
                        <input type="hidden" name="usage_id" id="usage_id">
                        <input type="number" class="form-control" name="usage" id="usage" placeholder="i.e. 500" required>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="fw-btn-fill btn btn-success ">Add Now</button>
                        <button type="button" class="fw-btn-fill btn btn-danger" data-dismiss="modal">cancel</button>
        ...
        <div class="dashboard-content-one">
            ...
            <div class="breadcrumbs-area">
                <div class="text-right w-100">
                    <a href="{{ route('add-inventory') }}" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark text-white">
                        Add Inventory
                    </a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="#">
                                            <button type="button" class="fw-btn-fill btn btn-primary stock" data-toggle="modal" data-target="#exampleModalCenter" 
                                            data-id="{{ $inventory_list->id }}" data-stock="{{ $inventory_list->stock }}">
                                                Add Stock
                                            </button>
                                        </a>
                                    </td>
                                    <td>
                                        <a class="dropdown-item" href="#">
                                            <button type="button" class="fw-btn-fill btn btn-primary usage" data-toggle="modal" data-target="#usageexampleModalCenter" 
                                            data-id="{{ $inventory_list->id }}" data-stock="{{ $inventory_list->usage }}">
                                                Add Usage
                                            </button>
                                        </a>
                                    </td>
