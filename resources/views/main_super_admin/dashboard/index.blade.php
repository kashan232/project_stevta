      ...
      @include('main_super_admin.dashboard.include.side_bar')
        ...
        <div class="dashboard-content-one"> 
          ...
          <div class="breadcrumbs-area">
            ...
            <ul>
              <li>
                <a href="{{ route('main-dashboard') }}">Home</a>
              </li>
              <li>Admin</li>
            </ul>
          </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-6">
                    <div class="item-content">
                      <div class="item-title">Institute</div>
                      <div class="item-number">
                        <span class="counter" data-num={{ $institute_counts }}>{{ $institute_counts }}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-6">
                    <div class="item-content">
                      ...
                      <div class="item-number">
                        <span class="counter" data-num={{ $campus_counts }}>{{ $campus_counts }}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="mt-4 mb-4 text-center">
                    <div class="item-title">
                      <h1>City Wise Registered Institute</h1>
                    </div>
                  </div>
