                    ...
                    <form class="new-added-form" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                <label>GRNO*</label>
                                <input type="text" name="item_name" id="item_name" placeholder="Enter Student GRNO"
                            ...
                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                ...
                                <input type="text" name="item_name" id="item_name"
                                    placeholder="Enter Student Father Name" required class="form-control" />
                            </div>

                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                <label>Select Category*</label>
                                <select class="form-control" id="inputGroupSelect02" name="gender">
                                    <option>Analysis fee(Chemistry Department)</option>
