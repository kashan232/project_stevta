            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Bonus</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">All Bonus</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div id="list-view" class="tab-pane fade active show col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">All Bonus</h4>
                                    <a href="{{ route('add-bonus') }}" class="btn btn-primary">+Add new</a>
                                </div>
                                <div class="card-body">
