            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-3 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-employees') }}">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-choose-month') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-employee-leave') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-holiday') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-department') }}">
