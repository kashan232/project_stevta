            ...
            <div class="container payroll-heading">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('Institute-admissions') }}">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-syllabus') }}">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-classes') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('institute-all-subjects') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                    ...
                    {{-- <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('fee-challan') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                                    <img src="/assets/subject-01.png" alt="">
                                </div>
                                <h5>Fee Challan Submission</h5>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center">
                        <a href="{{ route('mcqs-testing') }}">
                            <div class="box-main-card">
                                <div class="card-content">
                                    <img src="/assets/subject-01.png" alt="">
                                </div>
