                    ...
                    <div id="frame">
                        <div class="content" style="padding-bottom: 30px;"> 
                            ...
                            <div class="messages">
                                ...
                                <ul>
                                @foreach($get_all_teachers_messages as $get_all_teachers_messages)
                                   
                                    <li class="sent">
                                        <img src="http://emilcarlsson.se/assets/mikeross.png" alt="" />
                                        <p>{{$get_all_teachers_messages->message}} <br><small>recieved from : {{$get_all_teachers_messages->teacher_name}}</small></p>
