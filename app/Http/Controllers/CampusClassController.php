...
class CampusClassController extends Controller
{
    public function Campusall_classes(Request $request)
    {
        ...
        return view('campus_admin_panel.dashboard.Campus_Operations.classes.all_classes', [
            'pagename' => $pagename,
    ...
    public function Campusadd_class(Request $request)
    {
        $pagename = 'Add Class'; 
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
        ...
        $campusName = $request->session()->get('campus_name');
        return view('campus_admin_panel.dashboard.Campus_Operations.classes.add_class', [
            'pagename' => $pagename,
            // 'campuses' => $campuses,
        ]);
    }
    public function Campusstore_class(Request $request)
    {
        // dd($request);
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
    ...
    public function Campusadd_section(Request $request)
    {
        ...
        $classes = CampusClass::where('institute_id', $Institute_admin_id)
            ...
            ->get();
        $campusName = $request->session()->get('campus_name');
        return view('campus_admin_panel.dashboard.Campus_Operations.classes.add_section', [
            'pagename' => $pagename,
    ...
    public function Campusstore_section(Request $request)
    {
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
    ...
    public function Campussections_view(Request $request, $class_id)
    {
        $institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
        $campusName = $request->session()->get('campus_name');
        ...
        return view('campus_admin_panel.dashboard.Campus_Operations.classes.sections_view', [
            'class' => $class,
            'sections' => $sections,
        ]);
    }
