...
class CampusSingleSyllabusController extends Controller
{
    public function Campusall_syllabus(Request $request)
    {
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_Operations.Syllabus.all_syllabus',
            [
                'pagename' => $pagename,
    ...
    public function Campusadd_syllabus(Request $request)
    {
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
        ...
        return view(
            'campus_admin_panel.dashboard.Campus_Operations.Syllabus.add_syllabus',
            [
                'pagename' => $pagename,
                'classes' => $classes,
                'sections' => $sections,
    ...
    public function Campusstore_syllabus(Request $request)
    {
        // dd($request);
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
        ...
        $request->validate([
            'book_name' => [
                'required',
                Rule::unique('campus_syllabus')->where(function ($query) use ($campus_id, $class_name, $section_name, $subject_name) {
    ...
    public function Campusedit_syllabus(Request $request, $id)
    {
        ...
        $sections = Class_Section::where('institute_id', $Institute_admin_id)->where('campus_id', $campus_id)->get();
        $subjects = CampusSubject::where('institute_id', $Institute_admin_id)->where('campus_id', $campus_id)->get();
        return view('campus_admin_panel.dashboard.Campus_Operations.Syllabus.edit_syllabus', [
    ...
    public function Campussave_edit_syllabus(Request $request, $id)
    {
        $Institute_admin_id = $request->session()->get('Institute_admin_id');
        $campus_id = $request->session()->get('campus_id');
        $request->validate([
